...
@inline function saturation_adjustment(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment:\n")
            print_numerical_method(sat_adjust_method)
            print_T_guess(sat_adjust_method, T_guess)
            Utils._print(", e_int=", e_int)
            Utils._print(", ρ=", ρ)
            Utils._print(", q_tot=", q_tot)
            Utils._print(", T=", sol.root)
            Utils._print(", maxiter=", maxiter)
            Utils._print(", tol=", tol.tol, "\n")
        end
...
@inline function saturation_adjustment_given_peq(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment_peq:\n")
            print_numerical_method(sat_adjust_method)
            print_T_guess(sat_adjust_method, T_guess)
            Utils._print(", e_int=", e_int)
            Utils._print(", p=", p)
...
@inline function saturation_adjustment_given_phq(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment_phq:\n")
            print_numerical_method(sat_adjust_method)
            print_T_guess(sat_adjust_method, T_guess)
            Utils._print(", h=", h)
            Utils._print(", p=", p)
...
@inline function saturation_adjustment_ρpq(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment_ρpq:\n")
            print_numerical_method(sat_adjust_method)
            print_T_guess(sat_adjust_method, T_guess)
            Utils._print(", ρ=", ρ)
            Utils._print(", p=", p)
...
@inline function saturation_adjustment_given_ρθq(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment_given_ρθq:\n")
            Utils._print("    Method=SecantMethod")
            Utils._print(", ρ=", ρ)
            Utils._print(", θ_liq_ice=", θ_liq_ice)
            Utils._print(", q_tot=", q_tot)
            Utils._print(", T=", sol.root)
            Utils._print(", maxiter=", maxiter)
            Utils._print(", tol=", tol.tol, "\n")
...
@inline function saturation_adjustment_given_pθq(
    ...
    if !sol.converged
        if print_warning()
            Utils._print("-----------------------------------------\n")
            Utils._print("maxiter reached in saturation_adjustment_given_pθq:\n")
            print_numerical_method(sat_adjust_method)
            print_T_guess(sat_adjust_method, T_guess)
            Utils._print(", p=", p)
            Utils._print(", θ_liq_ice=", θ_liq_ice)
...
@inline function air_temperature_given_ρθq_nonlinear(
    ...
    if !sol.converged
        if print_warning()
            ...
            Utils._print(", θ_liq_ice=", θ_liq_ice)
            Utils._print(", ρ=", ρ)
            Utils._print(", q.tot=", q.tot)
            Utils._print(", q.liq=", q.liq)
            Utils._print(", q.ice=", q.ice)
            Utils._print(", T=", sol.root)
            Utils._print(", maxiter=", maxiter)
            Utils._print(", tol=", tol.tol, "\n")
        end
