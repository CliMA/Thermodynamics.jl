...
PhaseDry(param_set::TPS, e_int::FT, ρ::FT) where {FT} = PhaseDry{FT}(e_int, ρ)
...
Constructs a [`PhaseDry`](@ref) thermodynamic state from:
 ...
 - `T` temperature
"""
function PhaseDry_pT(param_set::TPS, p::FT, T::FT) where {FT <: Real}
...
"""
function PhaseDry_pe(param_set::TPS, p::FT, e_int::FT) where {FT <: Real}
...
"""
function PhaseDry_ρθ(param_set::TPS, ρ::FT, θ_dry::FT) where {FT <: Real}
...
Constructs a [`PhaseDry`](@ref) thermodynamic state from:
 ...
 - `θ_dry` dry potential temperature
"""
function PhaseDry_pθ(param_set::TPS, p::FT, θ_dry::FT) where {FT <: Real}
...
Constructs a [`PhaseDry`](@ref) thermodynamic state from:
 ...
 - `T` temperature
"""
function PhaseDry_ρT(param_set::TPS, ρ::FT, T::FT) where {FT <: Real}
    e_int = internal_energy(param_set, T)
    return PhaseDry{FT}(e_int, ρ)
end
...
Constructs a [`PhaseDry`](@ref) thermodynamic state from:
 ...
 - `p` pressure
"""
function PhaseDry_ρp(param_set::TPS, ρ::FT, p::FT) where {FT <: Real}
