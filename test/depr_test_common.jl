"""
# Common Parameters, Includes, and Functions for *deprecated* Thermodynamics Tests

This file contains common thermodynamic parameter definitions and tolerances
that are shared across tests for deprecated APIs (PhasePartition and thermodynamic
state methods that live in `src/depr_*`).
"""
...
atol_temperature = 0.5   # Expected absolute temperature accuracy
